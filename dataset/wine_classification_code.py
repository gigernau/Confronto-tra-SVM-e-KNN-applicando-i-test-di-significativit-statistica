...
TotalAmount = accuracy_score(y_test, y_pred)*100



with open("resA.txt", "a+") as text_file:
    print(f"{TotalAmount}", file=text_file)
...
print(accuracy_score(y_test, y_pred)*100)
TotalAmount2 = accuracy_score(y_test, y_pred)*100

with open("resB.txt", "a+") as text_file2:
    print(f"{TotalAmount2}", file=text_file2)
